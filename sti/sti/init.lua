...
function Map:drawImageLayer(layer)
	...
	if layer.image ~= "" then
    local offsetx = (layer.properties.fx or 0) * (layer.dx or 0)
    local offsety = (layer.properties.fy or 0) * (layer.dy or 0)
		lg.draw(layer.image, layer.x + offsetx, layer.y + offsety)
	end
end
